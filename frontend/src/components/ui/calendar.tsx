    ...
    <DayPicker
      ...
      formatters={{
        ...
        formatWeekdayName(weekday) {
          return format(weekday, 'EEEEEE', { locale: ptBR })
        },
        ...formatters,
      }}
      classNames={{
        ...
        dropdown_root: cn(
          'relative has-focus:border-ring border border-gray-300 shadow-xs has-focus:ring-ring/50 has-focus:ring-[3px] rounded-md',
        ...
        range_start: cn(
          'rounded-l-md bg-gray-300 text-gray-800',
          defaultClassNames.range_start
        ),
        range_middle: cn('rounded-none', defaultClassNames.range_middle),
        range_end: cn(
          'rounded-r-md bg-brand-base text-white',
          defaultClassNames.range_end
        ),
        today: cn(
          'bg-gray-200 text-gray-800 rounded-md data-[selected=true]:rounded-none',
